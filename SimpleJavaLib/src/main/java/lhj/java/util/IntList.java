...
public class IntList {
	...
	public IntList(int initialCapacity) {
		if (initialCapacity < 0)
			throw new IllegalArgumentException("Illegal Capacity: "
					+ initialCapacity);
		this.elementData = (int[]) new int[initialCapacity];
	}
	...
	public IntList(IntList c) {
		...
		elementData = (int[]) c.toArray(new int[capacity]);
	}
	...
	public void ensureCapacity(int minCapacity) {
		...
		if (minCapacity > oldCapacity) {
			...
			elementData = (int[]) new int[newCapacity];
			System.arraycopy(oldData, 0, elementData, 0, size);
		}
	}
	...
	public Object clone() {
		try {
			...
			v.elementData = (int[]) new int[size];
	...
	public int[] toArray(int[] a) {
		if (a.length < size)
			a = (int[]) java.lang.reflect.Array.newInstance(a.getClass()
	...
	private void readObject(java.io.ObjectInputStream s)
		...
		int[] a = elementData = (int[]) new int[arrayLength];
