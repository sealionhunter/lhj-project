...
public class ClassUtil {
	...
	/**
	 * 判断一个对象数组是否是同质数组。 这里的同质是严格的同质，即他们的实际类类型必须完全相同。
	 * 
	 * @param objects
	 *            要比较的对象数组
	...
	/**
	 * 判断一个对象数组是否是同质数组且是指定的类类型。 这里的同质是严格的同质，即他们的实际类类型必须完全相同。
	 * 
	 * @param objects
	 *            要比较的对象数组
	 * @param c
	...
	/**
	 * 得到JDK1.4所有的类名集合，只包含org,java,javax包及其子包下的类的类名。 每个元素的值只是类名，没有包名以及扩展名java。
	 * 
	 * @return 类名的集合
	 * @since 0.5
	 */
