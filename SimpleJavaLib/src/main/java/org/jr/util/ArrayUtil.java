...
public class ArrayUtil {
	...
	/**
	 * 将原数组的值拷贝到目标数组。 目标数组的大小必须大于等于原数组，一般应该是大小相等，如果目标数组的大小较大则大于的部分保留原值。
	 * 
	 * @param orginalArray
	 *            原数组
	 * @param targetArray
	...
	/**
	 * 将数组中的值移位。 移动的方式是将指定位置以后的每个元素依次往前移动一位，指定位置的值移到最后。
	 * 
	 * @param array
	 *            数组
	 * @param index
	...
	/**
	 * 将指定的值插入到数组中的指定位置。 数组最后一个元素的值将被丢弃。
	 * 
	 * @param array
	 * @param index
	 * @param value
