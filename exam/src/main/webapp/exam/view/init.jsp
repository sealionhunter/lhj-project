				...
				<tr>
					<td height="32" align="left" bgcolor="#FFFFFF" valign="middle"
						style="padding-left: 10px;"><b><span
							style="color: #666666">考试选择</span></b></td>
				</tr>
				<tr bgcolor="#FFFFFF">
						...
						<table width="80%" border="0" cellpadding="4" cellspacing="0"
							...
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="view/Regflow.html">报名流程</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="/exam/regist.action">报名登陆</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="/exam/statusSearch.action">查询/打印资审结果</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="/exam/regist.action?editFlg=1">信息修改</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="/exam//modifyPassword.action">修改密码</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
									href="/exam/applyinfo.action">报名情况浏览</a></td>
							</tr>
							<tr bgcolor="#ffffff">
								<td style="height: 10px; text-align: left;"><a
