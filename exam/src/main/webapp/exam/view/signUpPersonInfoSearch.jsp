...
<div class="cnt">
	<form:form name="registForm" method="post" action="/exam/applyinfo.action"
		commandName="RegistCommand">
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E1E1E1">
    <tr> 
        <td height="32" align="left" bgcolor="#FFFFFF" valign="middle" style="padding-left:10px;"><b><span style="color:#666666">报名人员信息一览</span></b></td>
    </tr>
    <%--
	<tr bgcolor="#FFFFFF"> 
    ...
    <tr bgcolor="#FFFFFF"> 
        <td valign="top" align="center" height="448" style="padding-top:5px;">
            <table width="95%"  border="0" cellpadding="8" cellspacing="1" bgcolor="#E1E1E1">
                <tr bgcolor="#f7f7f7">
