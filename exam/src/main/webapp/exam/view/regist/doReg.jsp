...
<form:form name="registForm" id="registForm" method="post" action="/exam/regist.action" commandName="RegistCommand">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td height="32" align="right" bgcolor="#FFFFFF" valign="middle"><b><span
							style="color: #666666">步骤：1.填写个人信息并设置密码-<span style="color: #ff3300">2.开始报名</span>-3.阅读报名须知并签订诚信承诺书-4.填写资格审查表-5.选择报考职位-6.上传照片-7.确认填写信息
						</span></b>&nbsp;&nbsp;</td>
				</tr>
				<tr bgcolor="#FFFFFF">
							...
							bgcolor="#E1E1E1">
								...
								<tr bgcolor="#f7f7f7">
									...
									<td width="15%" rowspan="2" align="center"><input
										type="submit" value="开始报名" onclick="return selectExam('${exam.id }', '${exam.name }');" name="_target2" /></td>
								</tr>
                                <tr bgcolor="#f7f7f7">
                                    <td width="35%" align="center"><fmt:formatDate pattern="yyyy/MM/dd HH:mm" value="${exam.applyBeginDate}"/>  ~ <fmt:formatDate pattern="yyyy/MM/dd HH:mm" value="${exam.applyDeadDate }" /></td>
                                </tr>
								</c:forEach>
								<tr bgcolor="#ffffff">
