...
public class UserSeatResetValidator implements Validator {

    @SuppressWarnings({ "rawtypes", "unchecked" })
    @Override
    public boolean supports(Class clazz) {
        return clazz.isAssignableFrom(UserSeatResetCommand.class);
    }

    @Override
    public void validate(Object target, Errors errors) {
        UserSeatResetCommand v = (UserSeatResetCommand) target;
