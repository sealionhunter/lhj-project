			...
			<table width="640" border="0" cellpadding="0" cellspacing="1"
				...
				<tr>
					<td height="32" align="center" bgcolor="#FFFFFF" valign="middle"
						style="padding: 20px;"><b>${AdmissionPrintCommand.exam.name}<br />
							准考证
					</b></td>
				</tr>
				<tr bgcolor="#FFFFFF">
				...
				<tr bgcolor="#FFFFFF">
					<td style="padding: 10px;">
						<table width="100%" border="0" cellpadding="4" cellspacing="0">
							<tr><td style="text-align:center; font-size:15px;">考生注意事项</td></tr>
							...
							<tr><td style="text-align:center; font-size:12px;">&nbsp;&nbsp;笔试结束后5天内在合肥猎头网（www.hfjyz.com）、阜阳合肥现代产业园区网（www.fhip.gov.cn）公布笔试成绩。</td></tr>
						</table>
					</td>
				</tr>
			</table>
