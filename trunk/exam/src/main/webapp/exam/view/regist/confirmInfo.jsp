...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E1E1E1">
    <tr> 
        <td height="32" align="right" bgcolor="#FFFFFF" valign="middle"><b><span style="color:#666666">步骤：1.填写个人信息并设置密码-2.开始报名-3.阅读报名须知并签订诚信承诺书-4.填写资格审查表-5.选择报考职位-6.上传照片-<span style="color:#ff3300">7.确认填写信息</span></span></b>&nbsp;&nbsp;</td>
    </tr>
    ...
    <tr bgcolor="#FFFFFF"> 
        ...
        <span align="center" style="color:#666666;font-size:14px;font-weight:600"><br />
            7.确认填写信息        </span><br /><br />
        <span align="center" style="color:#222222;font-size:16px;font-weight:600">${RegistCommand.registExamName}&nbsp;资格审查表</span>
        ...
        <table width="80%"  border="0" cellpadding="4" cellspacing="1" bgcolor="#E1E1E1">
          <tr bgcolor="#ffffff">
            ...
            <td rowspan="5"><img src="/exam/imageDownload?userId=${RegistCommand.idCardNo}" height="140px" width="102px"/></td>
          </tr>
          <tr bgcolor="#ffffff">
          ...
          <tr bgcolor="#ffffff">
            <td height="22" colspan="5">
              <div align="center">
                ...
                &nbsp;&nbsp;
                <input type="submit" value="确认无误，退出等待审核" name="_finish"/>
              </div>
            </td>
          </tr>
        </table>
