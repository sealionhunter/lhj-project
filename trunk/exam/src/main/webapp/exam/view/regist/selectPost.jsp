				...
				<table width="100%" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<td height="32" align="right" bgcolor="#FFFFFF" valign="middle"><b><span
								style="color: #666666">步骤：1.填写个人信息并设置密码 - 2.开始报名 -
									3.阅读报名须知并签订诚信承诺书 - 4.填写资格审查表 - <span style="color: #ff3300">5.选择报考职位</span>
									- 6.上传照片 - 7.确认填写信息
							</span></b>&nbsp;&nbsp;</td>
					</tr>
					<tr bgcolor="#FFFFFF">
						<td valign="top" align="center" height="300"><span
							...
							<table width="80%" border="0" cellpadding="4" cellspacing="1"
								...
								<tr bgcolor="#f7f7f7">
									...
									<td align="left"><form:select path="applyCityId"
											items="${RegistCommand.cities }" itemLabel="name"
											itemValue="id">
										</form:select></td>
								</tr>
								<tr bgcolor="#f7f7f7">
									<td align="right">报考部门：</td>
									<td align="left"><form:select path="applyDeptId"
											id="applyDeptId" items="${RegistCommand.departs }"
											itemLabel="name" itemValue="id" onchange="changeDeart();">
										</form:select></td>
								</tr>
								<tr bgcolor="#f7f7f7">
									<td align="right">岗位类别：</td>
									<td align="left"><form:select path="applyPostId"
											id="applyPostId">
										</form:select> <%-- <input type="button" value="查看此职位报名状况" />--%></td>
								</tr>
								<tr bgcolor="#ffffff">
	            ...
	            <c:forEach items="${RegistCommand.offices }" var="office">
	             ...
	             --%>
								...
								<tr bgcolor="#ffffff">
									...
									<td>1</td>
									<td>英语</td>
									<td>全日制本科及以上、具有相应学位，<br />英语专业具有专业八级证书
									</td>
								</tr>
								<tr bgcolor="#ffffff">
									<td>企业服务中心</td>
