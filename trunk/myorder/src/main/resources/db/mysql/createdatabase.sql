...
create table Hotel (uuid varchar(255) not null, address varchar(256) not null, description varchar(1024) null, foodCategory varchar(255) null, imgUrl varchar(512) null, maxService int not null, name varchar(256) not null, serviceFrom varchar(255) null, serviceTo varchar(255) null, telNum varchar(64) not null, primary key (uuid));
...
create table UserInfo (uid varchar(64) not null unique, address varchar(512) null, birthday datetime2 null, email varchar(64) null, hid varchar(255) null, isAdmin tinyint null, password varchar(64) not null, sex varchar(2) not null, mobile varchar(16) null, uname varchar(128) not null, validTo datetime2 null, primary key (uid));
